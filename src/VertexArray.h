...
public:
    VertexArray(VertexBuffer<T> vbo, IndexBuffer<V> ibo, std::span<Attribute> attribs) {
        ...
        for (int i = 0; i < attribs.size(); ++i) {
            ...
            glVertexArrayAttribFormat(id_, attrib.attrib_index, attrib.type_size.second, attrib.type_size.first, GL_FALSE, attrib.offset);
        }
